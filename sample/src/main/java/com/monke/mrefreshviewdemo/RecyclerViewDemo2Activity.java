...
import com.monke.mrefreshview.MRefreshRecyclerLineView;
...
public class RecyclerViewDemo2Activity extends AppCompatActivity {
    private MRefreshRecyclerLineView mrcv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mrcv = (MRefreshRecyclerLineView) findViewById(R.id.mrcv);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.linear:
                mrcv.setLayoutManager(new LinearLayoutManager(RecyclerViewDemo2Activity.this));
                break;
            case R.id.grid:
                mrcv.setLayoutManager(new GridLayoutManager(RecyclerViewDemo2Activity.this,2));
                break;
